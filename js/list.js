...
async function getPokemonList() {
    ...
    try {
        ...
        pokemonList.innerHTML = `
            <div class="pokemon-empty-message">
...
function renderPokemonList(pokemons) {
    ...
    const html = pokemons.map(pokemon => {
        ...
        const types = pokemon.types.map(item => {
            ...
            // Trả về HTML badge
            return `
                <span class="pokemon-card-type type-${typeName}">
                    <span>
                        ${typeIcons[typeName] || "✨"}
                    </span>
        ...
        return `
            ...
            >
                ...
                <div class="pokemon-card-content">
                    ...
                    <p class="pokemon-card-id">
                        #${formattedId}
                    </p>

                    <h2 class="pokemon-card-name">
    ...
    try {
        ...
        let html = `
            <div class="type-filter-buttons">
                ...
                <button
                    class="pokemon-type-filter active"
                    data-type="all"
                >
...
function updateActiveFilter() {
    ...
    // Lấy tất cả nút
    const buttons =
        document.querySelectorAll(".pokemon-type-filter");
...
async function renderFilteredPokemonPage() {
    ...
    try {
        ...
        // Lấy chi tiết
        pokemonData =
            await getPokemonDetails(pokemonPage);
